                                ...
                                <div id="post-103" class="page post-103 type-page status-publish hentry">
                                    ...
                                    <div class="title-box clearfix title-box__style-1">
                                        <h2 class="title-box_primary" style="font-size: {{$contact_title->fs}}px">
                                            ...
                                            <a style="color:white;margin-left:15px" class="pull-right update_section" href="0"
                                               data-toggle="modal" data-target="#modalUpdate"
                                               data-update_href="{{route('contacts_title')}}">
                                    ...
                                    <div class="span12">
                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d195168.32764022387!2d44.348481592772025!3d40.15330599674781!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x406aa2dab8fc8b5b%3A0x3d1479ae87da526a!2z0JXRgNC10LLQsNC9LCDQkNGA0LzQtdC90LjRjw!5e0!3m2!1sru!2sru!4v1498301433512" width="600" height="450" frameborder="0" style="border:0" allowfullscreen>
                                        </iframe>
                                    </div>

                                    <div class="span8 ">
                                        <div class="title-box clearfix title-box__style-1"><h2
                                                    class="title-box_primary">Contact Form</h2></div>
                                        <!-- //.title-box -->
                                        <div role="form" class="wpcf7" id="wpcf7-f208-p103-o1" dir="ltr">
                                            ...
                                            <form action="{{route('send_email')}}" method="post" class="wpcf7-form">
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <p class="span4 field"><span
                                                                class="wpcf7-form-control-wrap your-email"><input
                                                                    ...
                                                                    aria-required="true" aria-invalid="false"
                                                                    placeholder="E-mail*:" required/></span></p>
                                                    <p class="span4 field"><span
                                                                class="wpcf7-form-control-wrap your-phone"><input
                                                                    type="text" name="phone" value="" size="40"
                                                                    class="wpcf7-form-control wpcf7-text"
                                                                    aria-invalid="false" placeholder="Phone*:" required/></span>
                                                    </p>
                                                </div>
                                                <p class="field"><span
                                                ...
                                                <p class="submit-wrap"><input type="reset" value="clear"
