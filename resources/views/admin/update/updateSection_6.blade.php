        ...
        <form action="{{route('update_6')}}" method="post" class="formImage" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="span3">
                            <input type="text" name="l1_hy" value="{{$res->li1_hy}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l1_ru" value="{{$res->li1_ru}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l1_en" value="{{$res->li1_en}}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="span3">
                            <input type="text" name="l2_hy" value="{{$res->li2_hy}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l2_ru" value="{{$res->li2_ru}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l2_en" value="{{$res->li2_en}}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="span3">
                            <input type="text" name="l3_hy" value="{{$res->li3_hy}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l3_ru" value="{{$res->li3_ru}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l3_en" value="{{$res->li3_en}}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="span3">
                            <input type="text" name="l4_hy" value="{{$res->li4_hy}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l4_ru" value="{{$res->li4_ru}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l4_en" value="{{$res->li4_en}}">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="span3">
                            <input type="text" name="l5_hy" value="{{$res->li5_hy}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l5_ru" value="{{$res->li5_ru}}">
                        </div>
                        <div class="span3">
                            <input type="text" name="l5_en" value="{{$res->li5_en}}">
                        </div>
                    </div>
