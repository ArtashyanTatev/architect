...
{{--    <title>{{ config('app.name', 'Laravel') }}</title>--}}
    ...
    <head>
        ...
        <link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Lustria&amp;subset=latin' type='text/css' media='all'/>
        <link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Lobster&amp;subset=latin' type='text/css' media='all'/>
        ...
        <script type='text/javascript' src='http://maps.googleapis.com/maps/api/js?v=3.exp&amp;sensor=false&amp;ver=4.8'></script>
...
<div id="app">
    ...
    <div id="motopress-main" class="main-holder">
        ...
        <img style= "position: absolute;" src="{{asset('img/slider/'.$bodyImage)}}" />

            @include('admin.layouts.header')
        @yield('content')
        @include('admin.layouts.footer')
        @include('admin.update.modalUpdate')
    </div>
...
{{--<script type='text/javascript' src='{{ asset('js/jquery.simplr.smoothscroll.min5152.js') }}' id="smoot"></script>--}}
